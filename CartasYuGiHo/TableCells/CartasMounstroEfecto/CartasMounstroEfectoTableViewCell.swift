//
//  CartasMounstroEfectoTableViewCell.swift
//  CartasYuGiHo
//
...
class CartasMounstroEfectoTableViewCell: UITableViewCell {    
    ...
    public func setUpCartasMounstroEfecto (categoria : DataCard) {
